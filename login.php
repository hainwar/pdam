    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/memphis-colorful.png');">  
                ...
                <img src="img/bg/logo.png" alt="Logo" class="img-fluid mb-2" style="max-width: 100px;"> <!-- Ganti dengan path logo yang sesuai -->
                ...
                <form action="" method="post">
                    <div class="form-group user">
                        <input type="text" class="form-control w-50 mx-auto mb-2" placeholder="Masukkan Username" name="username" autocomplete="off" required>
                    </div>
                    <div class="form-group my-3">
                        <input type="password" class="form-control w-50 mx-auto mb-4" placeholder="Masukkan Password" name="password" autocomplete="off" required>
                    </div>
